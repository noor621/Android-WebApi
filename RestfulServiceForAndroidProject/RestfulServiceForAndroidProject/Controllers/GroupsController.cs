...
namespace RestfulServiceForAndroidProject.Controllers
{
    public class GroupsController : ApiController
    {
        ...
        // POST api/Groups
        [ResponseType(typeof(Group))]
        public IHttpActionResult PostGroup([FromBody][Bind(Include = "GName")]Group group)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            ...
            return CreatedAtRoute("DefaultApi", new { id = group.GID }, group);
        }
        ...
        {
            return db.Groups.Count(e => e.GID == id) > 0;
        }
    }
}